...
void load_microprog()
{
	...
	//}
    microprog[0] = 0b000000000100001101010000001000010001; //PC <- PC + 1; GOTO[MBR]
    ...
    microprog[5] = 0b000000000000001111000000000100000010; //mdr <-h +mbr; goto[0]
}
...
void load_prog()
{   //Comentado em Assembly:
    memory[0] = 0b00000000; //main
