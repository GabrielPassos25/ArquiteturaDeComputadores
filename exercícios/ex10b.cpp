...
void load_prog()
{
    memory[0] = 0b00000000; //não utilizada
    memory[1] = 0b00000010; //goto[mbr=2], fetch, goto[mbr=2]
    memory[2] = 0b00001010; //salva o valor memory[10*4] no mdr;
    memory[3] = 0b00000010; //goto[mbr=2]
    memory[4] = 0b00001011; //salva o valor memory[11*4] no mdr;
    memory[5] = 0b00000110; //goto[mbr=6]
    memory[6] = 0b00001100; //salva o valor 8 na memory[12*4]; 
    memory[40] = 0b00000101; //soma de opc + h
    memory[44] = 0b00000011; //soma de opc + h
}
