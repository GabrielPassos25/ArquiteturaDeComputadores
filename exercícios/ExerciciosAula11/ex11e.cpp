...
void load_prog()
{
    memory[1] = 0b00000010; //main (opc=x) //ADD OPC, [10]
    memory[2] = 0b00001010; //atribuir x para opc
    memory[3] = 0b00001011; //main (checar se x=0) //JZ
    memory[4] = 0b00111000; //se x =0
    memory[5] = 0b00001101; //main (decrementar OPC) //SUB OPC, [8]
    memory[6] = 0b00001000; //decrementar 1
    memory[7] = 0b00000110; //main (salvar opc) //MOV OPC, [10]
    memory[8] = 0b00001010; //posicao de salvar opc
    memory[9] = 0b00001101; //main (zerar opc) //SUB OPC, [10]
    memory[10] = 0b00001010; //posicao de x
    memory[11] = 0b00000010; //main (opc=1, para salvar o valor true) //ADD OPC, [8]
    memory[12] = 0b00001000; //salva o valor 1 em opc
    memory[13] = 0b00000110; //main (salvar resultado = true) //MOV OPC, [12]
    memory[14] = 0b00001100; //posicao do valor de resultado
    memory[15] = 0b00001101; //main (zerar opc) //SUB OPC, [8]
    memory[16] = 0b00001000; //posicao do 1
    memory[18] = 0b00000010; //main (opc=y) //ADD OPC, [11]
    memory[19] = 0b00001011; //atribuir y para opc
    memory[20] = 0b00001011; //main (checar se y=0) //JZ
    memory[21] = 0b00111000; //se y=0
    memory[22] = 0b00001101; //main (decrementar OPC) //SUB OPC, [8]
    memory[23] = 0b00001000; //decrementar 1
    memory[24] = 0b00000110; //main (salvar OPC) //MOV OPC, [11]
    memory[25] = 0b00001011; //posicao de salvar opc
    memory[26] = 0b00001101; //main (zerar OPC) //SUB OPC, [11]
    memory[27] = 0b00001011; //posicao de y
    memory[28] = 0b00000110; //main (salvar resultado = false) //MOV OPC, [12]
    memory[29] = 0b00001100; //posicao do resultado
    memory[30] = 0b00001001; //main (loop do programa) //GOTO 1
    memory[31] = 0b00000001; //PC=1, goto[2]
    memory[32] = 0b00000001; //constante 1;
    memory[40] = 0b00000010; //x = 2;
    memory[44] = 0b00000001; //y = 1;
    memory[48] = 0b00000000; //resultado;
    memory[52] = 0b00000000; //constante 0;
    memory[56] = 0b11111111; //se x,y = 0, acaba o programa com o valor de memory[48];
}
