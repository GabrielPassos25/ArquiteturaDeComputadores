...
void load_microprog()
{
    ...
    //OPC = OPC + memory[end_word]; memory[2][4][40][44] 
    ...
    microprog[5] = 0b000000000000001111000100000000001000; //OPC <- OPC + H; GOTO MAIN; OPC = 5; M[1] = 1; m[2] = 4; OPC =3; m[1]=0; m[3]=2 

    //memory[end_word] = OPC; memory[6][48]
...
void load_prog()
{
    ...
    memory[11] = 0b00000010;
    memory[12] = 0b00001011;
    memory[13] = 0b00000010;
    memory[14] = 0b00001100;
    memory[15] = 0b00000110;
    memory[16] = 0b00001011;
