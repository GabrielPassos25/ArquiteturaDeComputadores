...
void load_prog()
{
    memory[1] = 0b00000010; //main (opc=x)
    memory[2] = 0b00001010; //atribuir x para opc
    memory[3] = 0b00001011; //main (checar se x=0)
    memory[4] = 0b00111000; //se x =0
    memory[5] = 0b00001101; //main (decrementar OPC)
    memory[6] = 0b00001000; //decrementar 1
    memory[7] = 0b00000110; //main (salvar opc)
    memory[8] = 0b00001010; //posicao de salvar opc
    memory[9] = 0b00001101; //main (zerar opc)
    memory[10] = 0b00001010; //posicao de x
    memory[11] = 0b00000010; //main (opc=1, para salvar o valor true)
    memory[12] = 0b00001000; //salva o valor 1 em opc
    memory[13] = 0b00000110; //main (salvar resultado = true)
    memory[14] = 0b00001100; //posicao do valor de resultado
    memory[15] = 0b00001101; //main (zerar opc)
    memory[16] = 0b00001000; //posicao do 1
    memory[18] = 0b00000010; //main (opc=y)
    memory[19] = 0b00001011; //atribuir y para opc
    memory[20] = 0b00001011; //main (checar se y=0)
    memory[21] = 0b00111000; //se y=0
    memory[22] = 0b00001101; //main (decrementar OPC)
    memory[23] = 0b00001000; //decrementar 1
    memory[24] = 0b00000110; //main (salvar OPC)
    memory[25] = 0b00001011; //posicao de salvar opc
    memory[26] = 0b00001101; //main (zerar OPC)
    memory[27] = 0b00001011; //posicao de y
    memory[28] = 0b00000110; //main (salvar resultado = false)
    memory[29] = 0b00001100; //posicao do resultado
    memory[30] = 0b00001001; //main (loop do programa)
